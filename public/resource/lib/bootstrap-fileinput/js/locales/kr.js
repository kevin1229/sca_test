...
(function ($) {
    ...
    $.fn.fileinputLocales['kr'] = {
        ...
        msgInvalidFileExtension: '파일 "{name}" 확장자는 지원하지 않습니다. "{extensions}" 타입의 확장자를 선택해 주십시오.',
        msgFileTypes: {
            'image': 'image',
            'html': 'HTML',
            'text': 'text',
        ...
        msgUploadEnd: 'Done',
        msgUploadEmpty: '업로드 가능 데이터가 존재하지 않습니다. 파일을 다시 첨부하세요.',
        ...
        msgFoldersNotAllowed: '드래그 앤 드랍은 파일만 가능합니다! 드랍한 {n}번째 폴더는 첨부되지 않았습니다.',
        ...
        ajaxOperations: {
            deleteThumb: '파일 삭제',
            uploadThumb: '파일 업로드',
            uploadBatch: '파일 다중 업로드',
            uploadExtra: '폼데이터 업로드'
        },
        dropZoneTitle: '파일을 여기에 드래그 앤 드랍을 하십시오 &hellip;',
