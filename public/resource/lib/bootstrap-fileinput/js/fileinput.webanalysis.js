...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tActionUpload = ''; // CUSTOM //
            tActionDelete = ''; // CUSTOM //
            tActionZoom = ''; // CUSTOM //
        ...
        _initClickable: function () {
            ...
            $h.handler($zone, 'click', function (e) {
                var valid = self._raise('filecheckBeforeBrowse');
                if (valid == false) {
                    return;
                }
        ...
        _change: function (e) {
            ...
            // CUSTOM //
            var valid = self._raise('filecheckExtLength', {"tfiles" : tfiles, "dragFiles" : files, "isDrag" : isDragDrop, "folders" : folders});
            if (valid == false) {
                return;
            }
            // CUSTOM //
            ...
            if (self.maxFileCount > 0 && total > self.maxFileCount) {
                if (!self.autoReplace || len > self.maxFileCount) {
                    // CUSTOM START //
                    self._raise('filecheckMaxCount', [e]);
                    return;
                    // CUSTOM END //
    ...
    $.fn.fileinput2 = function (option) {
        ...
        this.each(function () {
            var self = $(this), data = self.data('fileinput'), options = typeof option === 'object' && option,
                ...
                lang = options.language || self.data('language') || $.fn.fileinput2.defaults.language || 'en', opt;
            if (!data) {
                if (theme) {
                ...
                opt = $.extend(true, {}, $.fn.fileinput2.defaults, t, $.fn.fileinputLocales.en, l, options, self.data());
    ...
    $.fn.fileinput2.Constructor = FileInput;
